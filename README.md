...
![Last Commit](https://img.shields.io/github/last-commit/yourusername/netflix-recommendation-system?style=flat-square)
![Repo Size](https://img.shields.io/github/repo-size/yourusername/netflix-recommendation-system?style=flat-square)
![Stars](https://img.shields.io/github/stars/yourusername/netflix-recommendation-system?style=flat-square)
![Forks](https://img.shields.io/github/forks/yourusername/netflix-recommendation-system?style=flat-square)
...
> 📓 View the notebook on Kaggle: **[Netflix Recommendation System — Kaggle Notebook](#)**
...
│   ├── top100_weighted_rating.csv           ← Top 100 movies by IMDB score
│   └── sample_recommendations.csv          ← Sample recommendation output
│
├── 📁 images/                               ← Plots saved by notebook
│   ├── overview_stats.png
│   ├── popularity_vs_rating.png
│   ├── tfidf_top_terms.png
│   ├── top15_weighted_rating.png
│   ├── engine_comparison.png
│   ├── similarity_deepdive.png
...
### Engine Comparison — Spider-Man: No Way Home
> *(Run the notebook to generate and save these charts)*

| Engine Comparison | Quality Analysis |
|:-:|:-:|
| ![Engine Comparison](images/engine_comparison.png) | ![Quality](images/quality_comparison.png) |

| TF-IDF Top Terms | Top 15 Weighted Rating |
|:-:|:-:|
| ![TF-IDF](images/tfidf_top_terms.png) | ![Top 15](images/top15_weighted_rating.png) |
...
🔗 Also check out the companion **[Netflix EDA Notebook](#)**
